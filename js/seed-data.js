 ...
 * seed-data.js
 * -----------------------------------------------------------------------
 * ⭐ THIS IS THE LIVE MENU. The `products`, `categories`, and `deals`
 * arrays below are read directly by the site on every page load — they
 * ARE the menu. To change a name, price, description, or add/remove a
 * menu item, edit this file and redeploy. This keeps the menu working
 * 100% reliably regardless of the database/network, since it never
 * depends on Supabase being configured or reachable.
 *
 * The ONLY thing that comes from the database is each item's PHOTO —
 * admins upload/change photos from the admin panel (Products & Deals
 * pages), stored in Supabase Storage + the `menu_item_images` table
 * (see supabase/hardcoded_menu_images.sql), matched back onto the items
 * below by their `id` field. Everything else here is the source of truth.
 *
 * STILL ACTIVELY USED too: `restaurant` (footer/contact info) and
 * `delivery_areas` (reference data).
 *
...
const LCP_SEED = {
  restaurant: {
    ...
    address:
      "Machli Chowk, Opp. Imam Bargah, East Circular Road, Gujrat, Punjab, Pakistan",
    phone_primary: "053-3521111",
    phone_secondary: "0371-0459420",
    phone_whatsapp: "0323-8677541",
    delivery_note:
      "Delivery available within 5 KM of Gujrat · Rs. 250 delivery charge",
    hours:
      "TODO: Opening hours not visible on reference menu — confirm with restaurant",
  },
  ...
  products: [
    // ---------------- OUR SPECIAL PIZZAS ----------------
    {
      ...
      name: "Little Chef Special Pizza",
      description: "Tomato, olives, sausages, mushroom.",
      sizes: { S: 690, M: 1180, L: 1790, F: 2650 },
      available: true,
      featured: true,
      verified: true,
    },
    {
      id: "p-chicken-extreme",
      category_id: "cat-special-pizza",
      name: "Chicken Extreme Pizza",
      description:
        "Special sauce, chicken, onion, capsicum, mushroom, red jalapeno, 3 types of chicken.",
      sizes: { S: 690, M: 1180, L: 1790, F: 2650 },
      available: true,
      featured: true,
      verified: true,
    ...
    {
      id: "p-malai-boti-pizza",
      category_id: "cat-special-pizza",
      name: "Malai Boti Pizza",
      description:
        "Special sauce, onion, malai boti, red jalapeno, cheese, onion, tomato.",
      sizes: { S: 690, M: 1180, L: 1790, F: 2650 },
      available: true,
      featured: true,
      verified: true,
    },
    {
      ...
      description:
        "Special sauce, onion, chicken, capsicum, green jalapeno, cheese, kebab.",
      sizes: { M: 1250, L: 1880, F: 2850 },
      available: true,
      featured: false,
      verified: true,
    },
    {
      ...
      name: "Crown Crust",
      description:
        "Special sauce, onion, chicken, capsicum, olives, tomato, cheese.",
      sizes: { M: 1390, L: 2050, F: 2970 },
      available: true,
      featured: false,
      verified: true,
    },
    {
      id: "p-chicken-stuffer",
      category_id: "cat-special-pizza",
      name: "Chicken Stuffer",
      description: "Special sauce, chicken, chicken kebab, onion, capsicum.",
      sizes: { M: 1350, L: 2050, F: 2870 },
      available: true,
      featured: false,
      verified: true,
    },
    {
      ...
      description:
        "Special sauce, chicken, chicken kebab, onion, capsicum. (description unclear vs. Chicken Stuffer — verify)",
      sizes: { M: 1350, L: 2050, F: 2870 },
      available: true,
      featured: false,
      verified: false,
    ...
    {
      id: "p-chicken-tikka",
      category_id: "cat-regular-pizza",
      name: "Chicken Tikka Pizza",
      description: "Tomato sauce, onion, chicken tikka, cheese.",
      sizes: { S: 650, M: 1130, L: 1670, F: 2450 },
      available: true,
      featured: false,
      verified: true,
    },
    ...
    {
      id: "p-tender-fillet-burger",
      category_id: "cat-fried-corner",
      name: "Tender Fillet Burger",
      description: "",
      price: 480,
      available: true,
      featured: false,
    ...
    {
      id: "p-mayo-fries-small",
      category_id: "cat-fried-corner",
      name: "Mayo Fries (Small)",
      description: "",
      price: 290,
      available: true,
      featured: false,
    ...
    {
      id: "p-chipotley-5",
      category_id: "cat-chipotley",
      name: "Chipotley Saucy Wings (5 Pcs)",
      description: "",
      price: 350,
      available: true,
      featured: false,
    ...
    },
    {
      id: "p-chipotley-10",
      category_id: "cat-chipotley",
      name: "Chipotley Saucy Wings (10 Pcs)",
      description: "",
      price: 700,
      available: true,
      featured: false,
    ...
    {
      id: "p-al-frado-pasta",
      category_id: "cat-oven-pasta",
      name: "Al Frado Pasta",
      description: "",
      sizes: { Half: 470, Full: 800 },
      available: true,
      featured: false,
      verified: true,
    },
    ...
    // ---------------- PLATTERS ----------------
    {
      id: "p-special-platter",
      category_id: "cat-platter",
      name: "Special Platter",
      description:
        "Oven baked wings (4 pcs), spin roll (4 pcs), 1 small fries, 1 dip sauce.",
      price: 1100,
      available: true,
      featured: false,
      verified: true,
    ...
    {
      id: "p-malai-boti-platter",
      category_id: "cat-platter",
      name: "Malai Boti Platter",
      description:
        "Malai boti wings (6 pcs), malai boti roll (4 pcs), 1 small fries, 1 dip sauce.",
      price: 1200,
      available: true,
      featured: true,
      verified: true,
  ...
  deals: [
    {
      id: "deal-1",
      name: "Deal 1",
      description: "1 Special Pizza (Large) + 10 Hot Wings + 1.5 Ltr Drink",
      price: 2450,
      available: true,
      featured: true,
      verified: true,
      items: [
        {
          product_id: "p-special-lcp",
          size: "L",
          qty: 1,
          note: "any special pizza, large",
        },
    ...
    },
    {
      ...
      name: "Deal 2",
      description:
        "1 Small Pizza (Regular) + 1 Creamy Pasta + 1 Half Ltr Drink",
      price: 1450,
      available: true,
      featured: false,
      verified: false, // TODO: VERIFY "Half Ltr Drink" against original menu image
      items: [
        {
          product_id: "p-chicken-tikka",
          size: "S",
          qty: 1,
          note: "any regular pizza, small",
        },
    ...
    },
    {
      id: "deal-3",
      name: "Deal 3",
      description: "1 Medium Pizza + 6 Hot Wings + 1 Ltr Drink",
      price: 1600,
      available: true,
      featured: false,
      verified: true,
    ...
    },
    {
      id: "deal-4",
      name: "Deal 4",
      description: "1 Large Pizza (Regular) + 1 Small Pizza + 1.5 Ltr Drink",
      price: 2480,
      available: true,
      featured: false,
      verified: true,
      items: [
        { product_id: "p-chicken-tikka", size: "L", qty: 1 },
        { product_id: "p-chicken-tikka", size: "S", qty: 1 },
        { product_id: "p-drink-15l", qty: 1 },
      ],
    },
    {
      ...
      name: "Deal 5",
      description:
        "1 Large Pizza (Regular) + 2 Zinger Burgers + 2 Petty Burgers + 1.5 Ltr Drink",
      price: 3200,
      available: true,
      featured: true,
      verified: true,
      items: [
        { product_id: "p-chicken-tikka", size: "L", qty: 1 },
        { product_id: "p-zinger-burger", qty: 2 },
        { product_id: "p-petty-cheese-burger", qty: 2 },
        { product_id: "p-drink-15l", qty: 1 },
      ],
    },
    {
      id: "deal-6",
      name: "Deal 6",
      description: "2 Large Pizzas (Regular) + 1 Large Fries + 1.5 Ltr Drink",
      price: 3900,
      available: true,
      featured: false,
      verified: true,
      items: [
        { product_id: "p-chicken-tikka", size: "L", qty: 2 },
        { product_id: "p-fries-large", qty: 1 },
        { product_id: "p-drink-15l", qty: 1 },
      ],
    },
  ],
